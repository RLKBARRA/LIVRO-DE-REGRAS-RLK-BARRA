...
**1.2.1.** Apenas vídeos com mais de 30 segundos com áudio do jogo e do seu microfone  são considerados **meios de prova** para punições administrativas. \
\
...
\
2.2. Jogadores suspeitos de utilizar tais softwares podem **passar por procedimentos de averiguação** para que voltem a ser liberados no servidor. \
\
2.2.1. Os procedimentos são detalhados na próxima seção.

***

#### **DO PROCEDIMENTO DE AVERIGUAÇÃO** <a href="#do-procedimento-de-averiguacao" id="do-procedimento-de-averiguacao"></a>
...
6.1. A BARRA **não divulga os resultados das telagens**, tampouco **armazena dados** relativos a tais, utilizando isso apenas como medida para proteger os interesses da comunidade.

6.1.1. **Exceção:** Nos casos em que o jogador de má-fé **tentar difamar o servidor** após o banimento, a barra poderá divulgar, por meio de suas redes, que **determinado jogador foi banido por uso de softwares maliciosos**. \
6.1.2. Esta medida será tomada apenas em **casos excepcionais**, com o objetivo de **proteger a imagem do servidor**.

> A Barra preza tanto pela **transparência** quanto pela **segurança e preservação da imagem** dos seus jogadores e ex-jogadores.

***

**Considerações Finais**

Essas regras visam criar um ambiente **justo e sadio** para todos os jogadores, garantindo **transparência e segurança** no servidor.
